...
$(document).ready(function () {
  ...
  const bookWidth = $("img").css("width").replace("px", "") * 0.91;
  const bookHeight = $("img").css("height").replace("px", "") * 0.91;

  const display = windowHeight > windowWidth ? "single" : "double";
  const backgroundSize = windowHeight > windowWidth ? "100% 100%" : "auto 100%";
  $('.pages [class^="page-num-"]').css("background-size", backgroundSize);
